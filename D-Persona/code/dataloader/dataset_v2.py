...
class BaseDataSets(Dataset):
    def __init__(
        ...
        if self.split == "train":
            self.sample_list = os.listdir(self._base_dir + "/training_2d_v2")
        elif self.split == "val":
            self.sample_list = os.listdir(self._base_dir + "/validation_v2")
    ...
    def __getitem__(self, idx):
        ...
        if self.split == "train":
            h5f = h5py.File(self._base_dir +"/training_2d_v2/{}".format(case), "r")
        elif self.split == "val":
            h5f = h5py.File(self._base_dir + "/validation_v2/{}".format(case), "r")
        elif self.split == "test":
