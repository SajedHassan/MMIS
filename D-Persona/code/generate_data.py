...
if __name__ == '__main__':
    ...
    parser.add_argument("--save_path", type=str, default='D-Persona/models/DPersona2_NPC_20241125-221742', help="save path")
    ...
    output_path = '/home/sajed/thesis/MMIS/dataset/ORG_1_ONLY_stage2_GENERATED/'
    ...
    db_train = BaseDataSets(
        ...
        split="gen",
        transform=ZoomGenerator(opt.PATCH_SIZE, 'gen')
    )
    ...
    metrics_dict = evaluate(net, train_loader, opt, args, result_path)
